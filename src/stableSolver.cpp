...
void StableSolver::solveLine(const std::vector<Node>& component, const std::vector<float>& weights) {
    std::vector<float> m_true(component.size(), 0.0f);
    std::vector<float> m_false(component.size(), 0.0f);
...
void StableSolver::solveCycle(const std::vector<Node>& component, const std::vector<float>& weights) {
